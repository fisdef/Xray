...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/sdsfsfsew/HerokuXray) 
...
如出现错误，可以多尝试几次，待部署完成后页面底部会显示`Your app was successfully deployed` 
  ...
  * 默认协议密码为`47b92802-69bb-45b9-a340-ac21f5bfeffc`，WS路径为$UUID-[vmess|vless|trojan|ss|socks]格式

### 客户端
* **务必替换所有的`xxx.herokuapp.com`为heroku分配的项目域名**  
* **务必替换所有的`47b92802-69bb-45b9-a340-ac21f5bfeffc`为部署时设置的UUID,建议更改,不要每个人都一样**  
